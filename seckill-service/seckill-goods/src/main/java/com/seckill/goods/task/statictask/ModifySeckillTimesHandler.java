...
import com.seckill.goods.task.SpringContext;
...
public class ModifySeckillTimesHandler implements SimpleJob {
    ...
    public void init() throws Exception {
        SeckillTimeService seckillTimeService = SpringContext.getBean(SeckillTimeService.class);
        ActivityService activityService = SpringContext.getBean(ActivityService.class);
        SkuActService skuActService = SpringContext.getBean(SkuActService.class);
