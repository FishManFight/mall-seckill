...
<div id="app">
    ...
    <div class="skileDetail">
        <div class="itemCont infoCont">
            ...
            <div class="item">
                <div class="info"><span>已选</span><span>${spec} 1件</span></div>
                <img src="./images/right.png" width="44" alt=""></div>
            <div class="item">
                <div class="info"><span>送至</span><span>广东省广州市</span></div>
                <img src="./images/right.png" width="44" alt=""></div>
        </div>
                ...
                <div class="item">
                    <div class="top">
                        <div class="info">
                            ...
                            <div style="color:#666;margin-left: 10px; font-size: 14px;">测试评论用户</div>
                        </div>
                        <div>
                    ...
                    <div class="des">
                        ...
                        <div style="margin: 10px 0">
                            <img src="${sku.image}" width="79" height="79" style="border-radius: 3px;"/>
                            <img src="${sku.image}" width="79" height="79" style="border-radius: 3px;"/>
                        </div>
                        <div class="font">
                            购买时间：2022-09-02 黑色，公开版，128GB,1件
                        </div>
                    </div>
                </div>
            </div>
